...
public class UpdateManager {
    ...
    private Handler mHandler = new Handler(){
    	public void handleMessage(Message msg) {
			...
			case DOWN_NOSDCARD:
				downloadDialog.dismiss();
				UIHelper.ToastMessage(mContext, R.layout.toastmessage_text, "无法下载安装文件，请检查SD卡是否挂载", Toast.LENGTH_SHORT);
				break;
			}
    	};
    };
...
//		AppClient.update(null, null, new ClientCallback() {
//			
//			@Override
...
//					ApkFile.delete();
				...
				conn.connect();
				Logger.i(conn.getHeaderFields().toString());
